    ...
    describe("Voice Registration", function() {
                ...
                it("should navigate to state_last_period_month", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/eng_NG/state_last_period_month_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                    ...
                    it("should navigate to state_retry_last_period_month", function() {
                        return tester
                            .setup.user.addr('07030010001')
                            .inputs(
                                {session_event: 'new'}
                            ...
                            .check.interaction({
                                state: 'state_retry_last_period_month',
                                reply: [
                            ...
                            .check.reply.properties({
                                helper_metadata: {
                                    voice: {
                                        speech_url: 'http://localhost:8001/api/v1/eng_NG/state_retry_last_period_month_1.mp3',
                                        wait_for: '#'
                                    }
                                }
                            })
                ...
                it("should navigate to state_last_period_month", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/eng_NG/state_last_period_month_2.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                ...
                it("should navigate to state_retry_last_period_month", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/eng_NG/state_retry_last_period_month_2.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
        ...
        describe("When you enter a baby_birth year", function() {
            describe("if 'this year' chosen", function() {
                it("should navigate to state_baby_birth_month", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/eng_NG/state_baby_birth_month_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                ...
                it("should navigate to state_retry_baby_birth_month", function() {
                    return tester
                        .setup.user.addr('07030010001')
                        .inputs(
                            {session_event: 'new'}
                        ...
                        .check.interaction({
                            state: 'state_retry_baby_birth_month',
                            reply: [
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/eng_NG/state_retry_baby_birth_month_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                ...
                it("should navigate to state_baby_birth_month", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/eng_NG/state_baby_birth_month_2.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                ...
                it("should navigate to state_retry_baby_birth_month", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/eng_NG/state_retry_baby_birth_month_2.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
