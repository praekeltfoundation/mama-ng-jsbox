        ...
        describe("Testing month validation function (is_valid_month)", function() {
            it("should return true/false if valid", function() {
                ...
                for (var i=0; i<choiceMonths.length; i++) {
                    resultsForThisYearPeriod.push(go.utils_HelloMama.is_valid_month(today, today.year(), (i+1).toString(), 10));
                    resultsForLastYearPeriod.push(go.utils_HelloMama.is_valid_month(today, todayLastYear.year(), (i+1).toString(), 10));
                    resultsForThisYearBaby.push(go.utils_HelloMama.is_valid_month(today, today.year(), (i+1).toString(), 13));
                    resultsForLastYearBaby.push(go.utils_HelloMama.is_valid_month(today, todayLastYear.year(), (i+1).toString(), 13));
                }
