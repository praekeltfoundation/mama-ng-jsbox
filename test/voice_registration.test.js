            ...
            it("should navigate to state r01_number", function() {
                return tester
                    ...
                    .check.reply.properties({
                        helper_metadata: {
                            voice: {
                                speech_url: 'http://localhost:8001/api/v1/en/state_r01_number_1.mp3',
                                wait_for: '#'
                            }
                        }
                    })
                ...
                it("should navigate to state r03_receiver", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r03_receiver_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                ...
                it("should navigate to state r02_retry_number", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r02_retry_number_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                ...
                it("should navigate to state r04_mom_state", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r04_mom_state_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                ...
                it("should navigate to state r05_birth_year", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r05_birth_year_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                ...
                it("should navigate to state r05_birth_year", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r05_birth_year_2.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                ...
                it("should navigate to state r06_birth_month", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r06_birth_month_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                ...
                it("should navigate to state r06_birth_month", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r06_birth_month_2.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
            ...
            it("should ask for month confirmation r07_confirm_month", function() {
                return tester
                    ...
                    .check.reply.properties({
                        helper_metadata: {
                            voice: {
                                speech_url: 'http://localhost:8001/api/v1/en/state_r07_confirm_month_6.mp3',
                                wait_for: '#'
                            }
                        }
                    })
                    ...
                    it("should navigate to state r08_birth_day", function() {
                        return tester
                            ...
                            .check.reply.properties({
                                helper_metadata: {
                                    voice: {
                                        speech_url: 'http://localhost:8001/api/v1/en/state_r08_birth_day_6.mp3',
                                        wait_for: '#'
                                    }
                                }
                            })
                    ...
                    it("should navigate to state r08_birth_day", function() {
                        return tester
                            ...
                            .check.reply.properties({
                                helper_metadata: {
                                    voice: {
                                        speech_url: 'http://localhost:8001/api/v1/en/state_r08_birth_day_23.mp3',
                                        wait_for: '#'
                                    }
                                }
                            })
                    ...
                    it("should navigate to state r08_birth_day", function() {
                        return tester
                            ...
                            .check.reply.properties({
                                helper_metadata: {
                                    voice: {
                                        speech_url: 'http://localhost:8001/api/v1/en/state_r08_birth_day_36.mp3',
                                        wait_for: '#'
                                    }
                                }
                            })
                ...
                it("should navigate to state r09_language", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r09_language_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
            ...
            it("should navigate to state r10_message_type", function() {
                return tester
                    ...
                    .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r10_message_type_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                ...
                it("should navigate to state r13_end", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r13_end_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
                ...
                it("should navigate to state r11_voice_days", function() {
                    return tester
                        ...
                        .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r11_voice_days_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
            ...
            it("should navigate to state r12_voice_times", function() {
                return tester
                    ...
                    .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r12_voice_times_1.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
            ...
            it("should navigate to state r13_end", function() {
                return tester
                    ...
                    .check.reply.properties({
                            helper_metadata: {
                                voice: {
                                    speech_url: 'http://localhost:8001/api/v1/en/state_r13_end_4.mp3',
                                    wait_for: '#'
                                }
                            }
                        })
