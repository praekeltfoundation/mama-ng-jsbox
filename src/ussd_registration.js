    ...
    // TEXT CONTENT
        ...
        var questions = {
            ...
            "state_msisdn_household":
                $("Please enter the {{roleplayer}}'s number. They will receive a weekly call and must consent to receiving messages."),
        ...
        var errors = {
            ...
            "state_msisdn_household":
                $("Sorry, that is not a valid number. Please enter the {{roleplayer}}'s number. They will receive a weekly call and must consent to receiving messages."),
            "state_last_period_day":
